  ...
  return (
    ...
    >
      ...
      {disabled && showTooltip && (
        <div className="absolute top-full mt-2 left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0 sm:right-0 bg-[var(--bg-surface-3)] border border-[var(--border)] text-[var(--text-primary)] text-[11px] font-bold py-2 px-3 rounded-xl shadow-2xl z-[999] animate-slide-up w-48 sm:w-auto whitespace-normal sm:whitespace-nowrap text-center">
